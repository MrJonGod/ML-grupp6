...
nltk.data.path.append(r'C:/Users/Ulfbj/AppData/Roaming/nltk_data')
...
# 1) Load the data
data_path = "C:/Users/Ulfbj/OneDrive/Documents/Machine learning/Grupparbete/ML-grupp6/Gruppuppgift-Ulf/Combined_final.csv"  # Student: adjust if your CSV is somewhere else
...
# 5. Download stopwords and define your stop-word removal function. Different code compared to the 
# template becuase original code provided a 'lookup error'
nltk.download('stopwords')
nltk.download('punkt')
stop_words = set(stopwords.words('swedish'))

# Use Punkt tokenizer for Swedish
punkt_tokenizer = PunktSentenceTokenizer(nltk.data.find('tokenizers/punkt/swedish.pickle'))

def removeStopWords(sentence):
    tokens = [word for sentence in punkt_tokenizer.tokenize(sentence) for word in sentence.split()]
