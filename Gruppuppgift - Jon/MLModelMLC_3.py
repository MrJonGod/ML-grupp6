...
It:
  ...
  - Trains a Naive Bayes-based OneVsRest model with GridSearchCV
...
# Define Naive Bayes model with GridSearchCV
param_grid = {'clf__estimator__alpha': [0.1, 0.5, 1.0, 2.0], 'clf__estimator__fit_prior': [True, False]}
nb_pipeline = Pipeline([
    ('clf', OneVsRestClassifier(MultinomialNB()))
])

grid = GridSearchCV(nb_pipeline, param_grid, cv=5, scoring='accuracy', n_jobs=-1)
